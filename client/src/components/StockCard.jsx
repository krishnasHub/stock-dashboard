export default function StockCard({ symbol, quote, selected, onSelect, onRemove }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: selected ? '0 0 0 2px #3b82f640' : 'none',
      }}
    ...
    >
      ...
      <div style={{
        fontSize: 13,
        fontWeight: 500,
        color: isUp === null ? '#64748b' : isUp ? '#22c55e' : '#ef4444',
      }}>
